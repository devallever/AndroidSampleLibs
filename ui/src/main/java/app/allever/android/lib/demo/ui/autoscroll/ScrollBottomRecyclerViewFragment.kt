...
class ScrollBottomRecyclerViewFragment: BaseFragment<FragmentScrollBottomRecyclerViewBinding, BaseViewModel>(){
    override fun getMvvmConfig() = MvvmConfig(R.layout.fragment_scroll_bottom_recycler_view, BR.scrollBottomRvVm)
