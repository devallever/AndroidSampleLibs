...
public class GalleryLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public int getCenterPosition() {
        ...
        for (int childPosition = 0; childPosition < childCount; childPosition++) {
            ...
            if (getDecoratedRight(child) > mParentWidth / 2) {
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(RecyclerView recyclerView, ArrayList<View> list, View item, int position);
    }
            ...
            if (snap != null) {
                ...
                if (selectedPosition != mCurSelectedPosition) {
                    ...
                    if (mOnItemSelectedListener != null) {
                        ...
                        try {
                            int mPosition = recyclerView.getChildCount();
                        ...
                        mOnItemSelectedListener.onItemSelected(recyclerView, mView, snap, mCurSelectedPosition);
                    }
                }
            }
        }
