...
class JetpackMainFragment : ListFragment<FragmentListBinding, ListViewModel, TextDetailItem>() {
    ...
    override fun getList() = mutableListOf(
        ...
        TextDetailItem("Room", "Room 持久性库在 SQLite 上提供了一个抽象层，以便在充分利用 SQLite 的强大功能的同时，能够流畅地访问数据库。"),
        TextDetailItem("DataBinding", "数据绑定库是一种支持库，借助该库，您可以使用声明性格式（而非程序化地）将布局中的界面组件绑定到应用中的数据源。"),
        TextDetailItem(
            "ViewBinding",
